...
def Generate():
 InputFile = Path("../.data/belarus-latest-internal.osm.pbf")
 OutputFile = Path("../docs/stat2.html")
 ...
 logger.info("##########################")
 logger.info(f"Апрацавана node: {OshHandler.CountNodes:10.2f}")
 logger.info(f"Апрацавана way: {OshHandler.CountWays:10.2f}")
 logger.info(f"Апрацавана relation: {OshHandler.CountRelations:10.2f}")
